...
class EquipeController extends AbstractController
{
    ...
    public function index(Request $request, EquipeRepository $equipeRepository, EntityManagerInterface $entityManager, JoueurRepository $joueurRepository,FlashyNotifier $flashy ,SessionInterface $session): Response
    {
        $user = $this->getUser();
