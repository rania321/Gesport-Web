...
class ActivitefavorisController extends AbstractController
{
    ...
    public function favoris(ActivitefavorisRepository $activitefavorisRepository, SessionInterface $session): Response
    {
        ...
        $activitefavoriss = $activitefavorisRepository->findBy(['user' => $user]);
