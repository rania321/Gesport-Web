...
class ActiviteController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($imageFile) {
                ...
                $imageFileName = $originalFileName.'.'.$imageFile->guessExtension();
                $imageFile->move(
    ...
    {
        $imagePath = 'C:\xampp\htdocs\images\\' . $imageName;
    ...
    public function show(Activite $activite, ActiviteRepository $activiteRepository, Request $request, SessionInterface $session): Response
    {
        $user = $this->getUser();
