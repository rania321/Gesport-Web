 ...
 */
class getActivitefavorisRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ActivitefavorisRepository' shared autowired service.
     *
     * @return \App\Repository\ActivitefavorisRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ActivitefavorisRepository.php';

        return $container->privates['App\\Repository\\ActivitefavorisRepository'] = new \App\Repository\ActivitefavorisRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
