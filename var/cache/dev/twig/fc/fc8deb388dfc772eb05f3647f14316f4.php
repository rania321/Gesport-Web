...
class __TwigTemplate_c48cddf86750f4b7bb932991630e0569 extends Template
{
    private $source;
    private $macros = [];
    ...
    <button class=\"btn btn-primary me-2\">";
        // line 3
        echo twig_escape_filter($this->env, ((array_key_exists("button_label", $context)) ? (_twig_default_filter((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 3, $this->source); })()), "Ajout")) : ("Ajout")), "html", null, true);
        echo "</button>
";
        // line 4
...
";
    ...
    {{ form_widget(form) }}
    <button class=\"btn btn-primary me-2\">{{ button_label|default('Ajout') }}</button>
{{ form_end(form) }}
", "activite/_form.html.twig", "C:\\Users\\Rania\\Desktop\\gesportWeb\\templates\\activite\\_form.html.twig");
    }
}
